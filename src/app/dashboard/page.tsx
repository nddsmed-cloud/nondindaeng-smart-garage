      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div>
            ...
            <div className="stat-sub">คัน ในระบบ</div>
          </div>
        </div>
        <div className="stat-card">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        ...
        <div>
          <div className="card-header" style={{ marginBottom: 12 }}>
            <h2 className="card-title">📝 คำขออนุญาตใช้รถล่าสุด</h2>
            <Link href="/requests" className="btn btn-ghost btn-sm">ดูทั้งหมด →</Link>
          </div>
            ...
            <table>
              ...
              <tbody>
                {recentRequests.length === 0 ? (
                  <tr><td colSpan={3} className="table-empty">ยังไม่มีคำขอ</td></tr>
                ) : (
